execute at @s run summon armor_stand ~ ~3 ~ {Invisible:true,Invulnerable:true,NoGravity:true,Tags:["item_storage"]}
scoreboard players set @r[nbt={Inventory:[{id:"minecraft:nether_star"}]}] enter 1
