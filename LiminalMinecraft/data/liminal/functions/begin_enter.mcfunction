execute if entity @a[nbt={Inventory:[{id:"minecraft:nether_star"}]},limit=1] as @a[nbt={Inventory:[{id:"minecraft:nether_star"}]},limit=1] at @s if block ~ ~1 ~ #concrete_powder run scoreboard players set @s enter 1
