...
execute if entity @e[tag=level1_gen,tag=!generated1] unless entity @e[tag=level1_gen_selected] as @r[gamemode=!survival] if dimension liminal:nowhere at @s as @e[tag=level1_gen,limit=1,tag=!generated1,sort=nearest] run tag @s add level1_gen_selected
