execute if entity @e[tag=level1_gen,tag=!generated] unless entity @e[tag=level1_gen_selected] as @e[tag=level1_gen,limit=1,tag=!generated,sort=nearest] run tag @s add level1_gen_selected
...
data modify entity @e[tag=level1_gen_selected,limit=1] ArmorItems[0].tag.StructureList.Array[3] set value 0
