...
scoreboard objectives add level1_gen_buffer dummy
scoreboard players set @a level1_gen_buffer 0
scoreboard objectives add gen_buffer dummy
scoreboard players set @a gen_buffer 1