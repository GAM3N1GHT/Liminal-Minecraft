...
execute if score @r level1_gen_buffer <= @r gen_buffer run scoreboard players add @a level1_gen_buffer 1
execute if entity @e[tag=level1_gen,tag=!generated1] if score @r level1_gen_buffer matches 2 run function liminal:level1_genstuff
