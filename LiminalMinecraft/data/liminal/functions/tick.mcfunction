...
execute if entity @e[tag=selected_l1,tag=generated] as @a if score @s SelectedUUID = @s UUID if score @s level1_cangen matches 1 if score @s level1_totaldif <= @s distanceCheck64 run tag @e[tag=selected_l1] add new1
